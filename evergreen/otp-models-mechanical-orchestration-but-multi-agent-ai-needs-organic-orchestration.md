...
- Context: [[emergent-agent-teams-need-an-environment-that-drives-toward-useful-collaboration-not-just-permissive-soft-constraints|Emergent agent teams need an environment that actively drives toward useful collaboration, not just soft constraints that permit it]]
